import type {Playlist, UserPlaylists, UserProfile} from "@/spotify/types";

export async function fetchCurrentUserPlaylists(accessToken: string): Promise<UserPlaylists> {
  return await asyncSpotify(accessToken, "/me/playlists")
}
